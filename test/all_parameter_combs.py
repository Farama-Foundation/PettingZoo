...
parameterized_envs = [
    ...
    (knights_archers_zombies_v8.env, dict(spawn_rate=50)),
    (knights_archers_zombies_v8.env, dict(num_knights=4, num_archers=5)),
    (knights_archers_zombies_v8.env, dict(killable_knights=True, killable_archers=True)),
    (knights_archers_zombies_v8.env, dict(killable_knights=False, killable_archers=False)),
    (knights_archers_zombies_v8.env, dict(line_death=False)),
    ...
    (knights_archers_zombies_v8.env, dict(vector_state=True, max_zombies=20)),
    (knights_archers_zombies_v8.env, dict(vector_state=True, use_typemasks=False)),
    (knights_archers_zombies_v8.env, dict(vector_state=True, max_arrows=50)),
    (knights_archers_zombies_v8.env, dict(vector_state=False, max_zombies=20)),
    (knights_archers_zombies_v8.env, dict(vector_state=False, use_typemasks=False)),
    (knights_archers_zombies_v8.env, dict(vector_state=False, max_arrows=50)),

    (pistonball_v6.env, dict(continuous=True)),
    (pistonball_v6.env, dict(n_pistons=30)),
    (pistonball_v6.env, dict(continuous=False)),
    (pistonball_v6.env, dict(random_drop=True, random_rotate=True)),
    (pistonball_v6.env, dict(random_drop=False, random_rotate=False)),
    ...
    (simple_adversary_v2.env, dict(N=4, continuous_actions=True)),
    (simple_reference_v2.env, dict(local_ratio=0.2, continuous_actions=True)),
    (simple_spread_v2.env, dict(N=5, continuous_actions=True)),
    (simple_tag_v2.env, dict(num_good=5, num_adversaries=10, num_obstacles=4, continuous_actions=True)),
    (simple_tag_v2.env, dict(num_good=1, num_adversaries=1, num_obstacles=1, continuous_actions=True)),
    (simple_world_comm_v2.env, dict(num_good=5, num_adversaries=10, num_obstacles=4, num_food=3, continuous_actions=True)),
    (simple_world_comm_v2.env, dict(num_good=1, num_adversaries=1, num_obstacles=1, num_food=1, continuous_actions=True)),

    (multiwalker_v8.env, dict(n_walkers=10)),
    (multiwalker_v8.env, dict(shared_reward=False)),
    (multiwalker_v8.env, dict(terminate_on_fall=False)),
    (multiwalker_v8.env, dict(terminate_on_fall=False, remove_on_fall=False)),
