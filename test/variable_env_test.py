...
def test_parallel_generated_agents_conversions():
    parallel_api_test(to_parallel(generated_agents_parallel_v0.env()), num_cycles=100)
    api_test(from_parallel(generated_agents_parallel_v0.parallel_env()), num_cycles=100)

    env1 = to_parallel(generated_agents_parallel_v0.parallel_env())
