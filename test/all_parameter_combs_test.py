...
parameterized_envs = [
    ...
    [
        "butterfly/knights_archers_zombies_v10",
        knights_archers_zombies_v10,
        dict(killable_knights=True, killable_archers=True, max_cycles=50),
    ],
    [
        "butterfly/knights_archers_zombies_v10",
        knights_archers_zombies_v10,
    ...
    [
        "butterfly/knights_archers_zombies_v10",
        knights_archers_zombies_v10,
        dict(line_death=False, max_cycles=50),
    ],
    [
        "butterfly/knights_archers_zombies_v10",
        knights_archers_zombies_v10,
    ...
    [
        "butterfly/knights_archers_zombies_v10",
        knights_archers_zombies_v10,
        dict(use_typemasks=False, max_cycles=50),
    ],
    [
        "butterfly/knights_archers_zombies_v10",
        knights_archers_zombies_v10,
    ...
    ["butterfly/pistonball_v6", pistonball_v6, dict(continuous=True, max_cycles=50)],
    ...
    [
        ...
        pistonball_v6,
        dict(random_drop=True, random_rotate=True, max_cycles=50),
    ],
    [
        "butterfly/pistonball_v6",
        pistonball_v6,
