...
def check_weapon_spawn(sword_spawn_rate, arrow_spawn_rate):
...
def zombie_knight(zombie_list, knight_list, all_sprites, knight_killed, sword_list, sword_killed):
...
def kill_sword(sword_killed, sword_list, all_sprites):
    for sword in sword_list:
...
def zombie_archer(zombie_list, archer_list, all_sprites, archer_killed):
    for zombie in zombie_list:
...
def zombie_sword(zombie_list, sword_list, all_sprites, score):
    for sword in sword_list:
...
def zombie_arrow(zombie_list, arrow_list, all_sprites, score):
