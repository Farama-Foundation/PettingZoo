...
:param knock_reward:  reward received by a player who knocks
:param gin_reward:  reward received by a player who goes gin
:param opponents_hand_visible:  Set to `True` to observe the entire observation space as described in `Observation Space` below. Setting it to `False` will remove any observation of the unknown cards and the observation space will only include planes 0 to 3.
"""
