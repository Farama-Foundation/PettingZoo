...
assert chess_utils.get_move_plane(chess.Move.from_uci("e1g1"), chess.KING) == chess_utils.get_queen_plane(
    (2, 0)
)  # castles kingside
assert chess_utils.get_move_plane(chess.Move.from_uci("g1f3"), chess.KNIGHT) == 56 + chess_utils.get_knight_dir(
    (-1, 2)
)  # castles kingside
