...
:param colors:param : Number of colors the cards can take (affects size of deck)
:param rank:param : Number of ranks the cards can take (affects size of deck)
:param hand_size:param : Size of player's hands. Standard game is (4 if players >= 4 else 5)
:param max_information_tokens:param : Maximum number of information tokens (more tokens makes the game easier by allowing more information to be revealed)
:param max_life_tokens:param : Maximum number of life tokens (more tokens makes the game easier by allowing more information to be revealed)
:param observation_type:param : 0: Minimal observation. 1: First-order common knowledge observation (default).
"""
