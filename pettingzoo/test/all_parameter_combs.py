...
parameterized_envs = [
    ...
    (knights_archers_zombies_v5.env, dict(spawn_rate=50)),
    (knights_archers_zombies_v5.env, dict(num_knights=4, num_archers=5)),
    (knights_archers_zombies_v5.env, dict(killable_knights=True, killable_archers=True)),
    (knights_archers_zombies_v5.env, dict(killable_knights=False, killable_archers=False)),
    (knights_archers_zombies_v5.env, dict(line_death=False)),
    (knights_archers_zombies_v5.env, dict(pad_observation=False)),
    (knights_archers_zombies_v5.env, dict(max_cycles=100)),
    ...
    (go_v2.env, dict(board_size=13, komi=2.5)),
    (go_v2.env, dict(board_size=9, komi=0.)),

    (hanabi_v3.env, dict(colors=3)),
    (hanabi_v3.env, dict(ranks=3)),
    (hanabi_v3.env, dict(players=4)),
    (hanabi_v3.env, dict(hand_size=5)),
    (hanabi_v3.env, dict(max_information_tokens=3)),
    (hanabi_v3.env, dict(max_life_tokens=2)),
    (hanabi_v3.env, dict(colors=5, ranks=3, players=4, hand_size=5, max_information_tokens=3, max_life_tokens=2)),
    (hanabi_v3.env, dict(observation_type=0)),
    (hanabi_v3.env, dict(observation_type=1)),
