"""
Wrapping PettingZoo environments into the matching Gymnasium environments for specific agent by providing
the action for all other agents.
"""
...
def parallel_to_gymnasium(
  ...
  class Parallel2GymnasiumEnv(gymnasium.Env):
