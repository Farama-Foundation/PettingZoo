...
parameterized_envs = [
    ...
    (knights_archers_zombies_v3.env, dict(spawn_rate=50)),
    (knights_archers_zombies_v3.env, dict(num_knights=4,num_archers=5)),
    (knights_archers_zombies_v3.env, dict(killable_knights=True, killable_archers=True)),
    (knights_archers_zombies_v3.env, dict(killable_knights=False, killable_archers=False)),
    (knights_archers_zombies_v3.env, dict(black_death=False)),
    (knights_archers_zombies_v3.env, dict(line_death=False)),
    (knights_archers_zombies_v3.env, dict(pad_observation=False)),
    (knights_archers_zombies_v3.env, dict(max_cycles=100)),

    (pistonball_v1.env, dict(local_ratio=0.7)),
    (pistonball_v1.env, dict(continuous=True)),
    (pistonball_v1.env, dict(continuous=False)),
    (pistonball_v1.env, dict(random_drop=True, starting_angular_momentum=True)),
    (pistonball_v1.env, dict(random_drop=False, starting_angular_momentum=False)),

    (prison_v2.env, dict(continuous=True)),
    (prison_v2.env, dict(continuous=False)),
    (prison_v2.env, dict(vector_observation=True)),
    (prison_v2.env, dict(vector_observation=False)),
    (prison_v2.env, dict(num_floors=1)),
    (prison_v2.env, dict(num_floors=5)),
    (prison_v2.env, dict(synchronized_start=True)),
    (prison_v2.env, dict(synchronized_start=False)),
    (prison_v2.env, dict(identical_aliens=True)),
    (prison_v2.env, dict(identical_aliens=False)),
    (prison_v2.env, dict(random_aliens=True)),
    ...
    (hanabi_v1.env, dict(colors = 3)),
    (hanabi_v1.env, dict(ranks = 3)),
    (hanabi_v1.env, dict(players=4)),
    (hanabi_v1.env, dict(hand_size=5)),
    (hanabi_v1.env, dict(max_information_tokens=3)),
    (hanabi_v1.env, dict(max_life_tokens=2)),
    (hanabi_v1.env, dict(colors = 5, ranks = 3, players=4, hand_size=5, max_information_tokens=3, max_life_tokens=2)),
    (hanabi_v1.env, dict(observation_type=0)),
    (hanabi_v1.env, dict(observation_type=1)),
    (hanabi_v1.env, dict(random_start_player=False)),
    (hanabi_v1.env, dict(random_start_player=True)),
    ...
    (multiwalker_v4.env, dict(n_walkers=10)),
    (multiwalker_v4.env, dict(local_ratio=0.5)),
    (multiwalker_v4.env, dict(terminate_on_fall=True)),
    (multiwalker_v4.env, dict(terminate_on_fall=False)),
