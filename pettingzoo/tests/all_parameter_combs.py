...
parameterized_envs = [
    ...
    (maze_craze_v1.env, dict(game_version="race")),
    (maze_craze_v1.env, dict(game_version="capture")),
    (maze_craze_v1.env, dict(visibilty_level=1)),
    (maze_craze_v1.env, dict(visibilty_level=3)),
    ...
    (waterworld_v1.env, dict(n_coop=1)),
    (waterworld_v1.env, dict(n_coop=1)),
    (waterworld_v1.env, dict(n_poison=4)),
    (waterworld_v1.env, dict(n_sensors=4)),
    (waterworld_v1.env, dict(terminate_on_fall=False)),
    (waterworld_v1.env, dict(local_ratio=0.5)),
    (waterworld_v1.env, dict(speed_features=False)),
]
