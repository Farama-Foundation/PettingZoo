...
OBSERVATION_SHAPE = (5 * AGENT_DIAMETER, 5 * AGENT_DIAMETER, 3)
...
FENCE_INFO = [
    ...
    ("right", [SCREEN_WIDTH - FENCE_WIDTH, 0], [SCREEN_WIDTH - (FENCE_WIDTH + FENCE_COLLISION_BUFFER), 0], FENCE_VERT_VERTICES),
]
