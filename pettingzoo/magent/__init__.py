...
combined_arms_v4 = DeprecatedModule("combined_arms", "v3", "v4")
gather_v0 = DeprecatedModule("gather", "v0", "v3")
gather_v1 = DeprecatedModule("gather", "v1", "v3")
gather_v3 = DeprecatedModule("gather", "v2", "v3")
