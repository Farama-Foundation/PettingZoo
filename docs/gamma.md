...
All other environments require a high degree of coordination and learning emergent behaviors to achieve an optimal policy. As such, good performance on these environments is extraordinarily difficult with current MADRL methods. We introduce these as a challenge to the community.
