...
def parse_args():
    ...
    parser.add_argument("--env-id", type=str, default="ALE/SpaceInvaders-v5", #default="BreakoutNoFrameskip-v4"
    ...
    parser.add_argument("--eval-steps", type=int, default=250_000,
        help="the number of steps to run in each environment per policy rollout")
    ...
    for update in range(1, num_updates + 1):
        ...
        for step in range(0, args.num_steps):
            ...
            if global_step % (args.eval_steps) == 0 and step != 0:
                print('Running evaluation at steps: ', global_step)
                eval_rewards = evaluate(args, agent)
                print(f'Episode rewards in last {args.eval_episodes} evaluation episodes = {eval_rewards}')
                print(f'Average reward in last {args.eval_episodes} evaluation episodes = {np.mean(eval_rewards)}')
